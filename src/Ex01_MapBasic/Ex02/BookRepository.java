...
public class BookRepository {
    ...
    // 이미 만들어 둔 DTO의 id를 사용
    public  boolean save(BookDTO bookDTO){  //
        System.out.println(bookDTO);
        BookDTO dto = bookDTOMap.put(bookDTO.getId(), bookDTO);  // map에 저장시 key, value 같이 채워야 함
    ...
    public BookDTO findById(Long id) {
        // map 에서 조회하려는 id와 일치하는 것을 찾아서 bookDTO 객체 리턴
    ...
    public List<BookDTO> search(String bookTitle) {
        ...
        }return bookDTOList; // 일치하는 것 모두 담은 후 리턴
    }
}
